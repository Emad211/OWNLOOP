...
const MULTI_AGENT_EVENT_SOURCE_SQL = `
ALTER TABLE events RENAME TO events_v18_source_constraint;
...
INSERT INTO events SELECT * FROM events_v18_source_constraint;
DROP TABLE events_v18_source_constraint;
