export const MULTI_AGENT_EVENT_TAXONOMY_SQL = `
ALTER TABLE events RENAME TO events_v19_type_constraint;
...
INSERT INTO events SELECT * FROM events_v19_type_constraint;
DROP TABLE events_v19_type_constraint;
