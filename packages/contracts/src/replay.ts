...
export const ReplayTimelinePayloadV1Schema = z.strictObject({
  ...
  outputEvidenceCount: z.number().int().nonnegative().optional(),
  outputEvidencePresent: z.boolean().optional(),
  recognized: z.boolean().optional(),
  verificationKind: z.enum(["test", "lint", "typecheck", "build", "unknown"]).optional(),
